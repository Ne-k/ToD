...
module.exports = function (logMessage, type = "info") {
    ...
    switch (type) {
        ...
        case "statsPosted":
            logString = colors.white(logMessage);
            logFormatting = colors.bgGreen(
                colors.white(colors.bold("[ STATS POSTED ]"))
            );
            break;
        case "event":
            logString = colors.white(logMessage);
        ...
        case "blacklist":
            logString = colors.white(logMessage);
            logFormatting = colors.bgRed(
                colors.white(colors.bold("[ BLACKLISTED USER ]"))
            );
            break;
        ...
        case "StatcordError":
            logString = colors.white(logMessage);
            logFormatting = colors.bgRed(
                colors.white(colors.bold("[ STATCORD ERROR ]"))
            );
            break;
        case "database":
            logString = colors.white(logMessage);
        ...
        case "guildCreate":
            logString = colors.white(logMessage);
            logFormatting = colors.bgGreen(
                colors.white(colors.bold("[ GUILD JOINED ]"))
            );
            break;
        case "guildDelete":
            logString = colors.white(logMessage);
            logFormatting = colors.bgYellow(
                colors.white(colors.bold("[ GUILD LEAVE ]"))
            );
            break;
        case "error":
            logString = colors.white(logMessage);
        ...
        case "dbError":
            logString = colors.white(logMessage);
            logFormatting = colors.bgRed(
                colors.white(colors.bold("[ DATABASE ERROR ]"))
            );
            break;
        case "warn":
            logString = colors.white(logMessage);
        ...
        case "buttonClick":
            logString = colors.white(logMessage);
            logFormatting = colors.bgBlue(
                colors.white(colors.bold("[ BUTTON CLICK ]"))
            );
            break;
        case "command error":
            logString = colors.white(logMessage);
            logFormatting = colors.bgRed(
                colors.white(colors.bold("[ COMMAND ERROR ]"))
            );
            break;
    }
