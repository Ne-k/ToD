    ...
    run: async (client, message, args) => {
        if (talkedRecently.has(message.author.id)) {
            return message.channel.send({
                embeds: [
                    new MessageEmbed()
                        .setDescription("As much as we appreciate your suggestion, please wait up to **1 minute** before using this command again, this is to prevent spam.")
                        .setColor("RANDOM"),
                ],
            });
        } else {
                        ...
                        client.on("interactionCreate", async (interaction) => {
                            if (interaction.customId === "agree") {
                                ...
                                const webhookClient = new WebhookClient({
                                    ...
                                    token: "3Q6qRGlq2Zc9EdjPIpI3_LiZggM7nlu5fmL7gjYTviK-05pRMOMHX1Q65iEyzOEKL4Io",
                                });
                                ...
                                let finalembed = new MessageEmbed()
                                    ...
                                    .setColor("GREEN")
                                    .setDescription(`Your suggestion has successfully been sent to the development server to be reviewed! <:KannaPet:843534507419107338>`);
