...
module.exports = {
    ...
    run: async (bot, message, args) => {
      ...
      let botping = Date.now() - message.createdTimestamp
        ...
        if (message.channel.type == "dm") return message.channel.send(":x: | This command command is disabled for DMs, please use this within a server!");
        message.channel.send("<a:Loading:824333296141467669> Pinging...").then(m => {
            m.edit(`🏓Pong!`)
