              ...
              "components": [
                  {
                      ...
                      "options":[
                          ...
                          },
                          {
                              "label": `#8`,
                              "value": "7",
                              "description": `${data[07].name.substring(0, 45) + '. . .'}`,
      ...
      const dominantColor = await getColorFromURL(s1.picture)
             ...
             .addField(`Trailer:`, `**[${s1.title}'s Trailer](${s1.trailer})**`, true)
              ...
              if(interaction.values[0] == 6) {
                  ...
                  malScraper.getInfoFromName(data[6].name)
      ...
      const dominantColor = await getColorFromURL(s1.picture)
             ...
             .addField(`Trailer:`, `**[${s1.title}'s Trailer](${s1.trailer})**`, true)
              ...
              if(interaction.values[0] == 7) {
                  ...
                  malScraper.getInfoFromName(data[7].name)
      ...
      const dominantColor = await getColorFromURL(s1.picture)
             ...
             .addField(`Trailer:`, `**[${s1.title}'s Trailer](${s1.trailer})**`, true)
              ...
              if(interaction.values[0] == 8) {
                  ...
                  malScraper.getInfoFromName(data[8].name)
      ...
      const dominantColor = await getColorFromURL(s1.picture)
             ...
             .addField(`Trailer:`, `**[${s1.title}'s Trailer](${s1.trailer})**`, true)
              ...
              if(interaction.values[0] == 9) {
                  ...
                  malScraper.getInfoFromName(data[9].name)
