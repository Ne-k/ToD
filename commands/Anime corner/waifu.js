...
module.exports = {
  config: {
    ...
    usage: "waifu",
    description:
      "Sends a embed with a random waifu from `https://mywaifulist.moe`.",
  },
  run: async (client, message, args) => {
      ...
      message.channel.send({
        embeds: [
          new Discord.MessageEmbed()
            .setColor("RED")
            .setTitle("This command is disabled due to being broken.")
            .setDescription(
    ...
    if (args.join(" ") == "random") {
      require("node-fetch")(`https://casey.gg/api/mwl?type=randomwaifu`, {
        headers: { token: process.env.mwl_API_key },
      })
        .then((res) => res.json())
        .then((d) => {
          return message.channel.send({
            embeds: [
              new Discord.MessageEmbed()
                .setImage(d.data.display_picture)
                ...
                .setColor("GOLD")
                .setFooter(
                  `❤️ ${d.data.likes} likes | 🗑️ ${d.data.trash} dislikes`
                ),
            ],
          });
        });
    ...
    if (args.join(" ") === "popular") {
      ...
      require("node-fetch")(`https://japi.rest/mywaifulist/v1/popular`, {
        headers: { Authorization: process.env.japi_API_key },
      })
        .then((res) => res.json())
        .then((d) => {
 ...
 "components": [
          ...
          return message.channel
            .send({
              embeds: [
                new Discord.MessageEmbed()
                  .setTitle("Popular Waifus (alltime) ranking")
                  .setColor("RANDOM")
                  .setFooter("This message will be deleted in 6 minutes.")
                  .setDescription(
                    d.data.map((t, i) => `**#${i + 1}** - ${t.name}`).join("\n")
                  ),
              ],
              ...
              client.on("interactionCreate", async (interaction) => {
                ...
                if (interaction.user.id !== message.author.id) {
                  return interaction.reply({
                    content: `You aren't allowed to click this selection!`,
                    ephemeral: true,
                  });
                }
                  ...
                  msg.edit({
                    embeds: [
                      new Discord.MessageEmbed()
                        .setFooter("This message will be deleted in 6 minutes.")
                        .setFooter("This message will be deleted in 6 minutes.")
                        .setTitle("Popular Waifus (alltime)")
                        .setColor("RANDOM")
                        .setDescription(
                          d.data
                            .map((t, i) => `**${i + 1}** - ${t.name}`)
                ...
                if (interaction.values[0] == 0) {
                  ...
                  let arrayBuffer = await require("node-fetch")(
                  ...
                  msg.edit({
                    embeds: [
                      new Discord.MessageEmbed()
                        ...
                        .setFooter(
                          `❤️ ${data.likes.toLocaleString()} likes | 🗑️ ${data.trash.toLocaleString()} dislikes`
                        )
                        .setColor(colorThief.getColor(buffer)),
                    ],
                  });
                }
                  ...
                  msg.edit({
                    embeds: [
                      new Discord.MessageEmbed()
                        ...
                        .setDescription(
                          data.description.substring(0, 4068) + ". . ."
                        )
                        .setImage(data.display_picture)
                        .setFooter(
                          `❤️ ${data.likes.toLocaleString()} likes | 🗑️ ${data.trash.toLocaleString()} dislikes`
    ...
    if (args.join(" ") === "best") {
      ...
      require("node-fetch")(`https://japi.rest/mywaifulist/v1/current/best`, {
        headers: { Authorization: process.env.japi_API_key },
      })
        .then((res) => res.json())
        .then((d) => {
          return message.channel
            .send({
              embeds: [
                new Discord.MessageEmbed()
                  .setTitle("Seasonal best waifus ranking")
                  .setFooter("This message will be deleted in 6 minutes.")
                  .setColor("RANDOM")
                  .setDescription(
                    d.data.map((t, i) => `**#${i + 1}** - ${t.name}`).join("\n")
    ...
    if (args.join(" ") === "top") {
      ...
      require("node-fetch")(`https://japi.rest/mywaifulist/v1/best`, {
        headers: { Authorization: process.env.japi_API_key },
      })
        .then((res) => res.json())
        .then((d) => {
          return message.channel
            .send({
              embeds: [
                new Discord.MessageEmbed()
                  .setTitle("Top tier waifus ranking")
                  .setColor("RANDOM")
                  .setFooter("This message wull be deleted in 6 minutes.")
                  .setDescription(
                    d.data.map((t, i) => `**#${i + 1}** - ${t.name}`).join("\n")
                  ),
              ],
    ...
    if (args.join(" ") === "trash") {
      ...
      require("node-fetch")(`https://japi.rest/mywaifulist/v1/trash`, {
        headers: { Authorization: process.env.japi_API_key },
      })
        .then((res) => res.json())
        .then((d) => {
          return message.channel
            .send({
              embeds: [
                new Discord.MessageEmbed()
                  .setTitle("Top trash waifu ranking")
                  .setColor("RANDOM")
                  .setFooter("This message wull be deleted in 6 minutes.")
                  .setDescription(
                    d.data.map((t, i) => `**#${i + 1}** - ${t.name}`).join("\n")
    ...
    if (args.join(" ") === "spopular") {
      ...
      require("node-fetch")(
        `https://japi.rest/mywaifulist/v1/current/popular`,
        { headers: { Authorization: process.env.japi_API_key } }
      )
        .then((res) => res.json())
        .then((d) => {
          return message.channel
            .send({
              embeds: [
                new Discord.MessageEmbed()
                  .setTitle("Seasonal most popular waifu ranking")
                  .setColor("RANDOM")
                  .setFooter("This message wull be deleted in 6 minutes.")
                  .setDescription(
                    d.data.map((t, i) => `**#${i + 1}** - ${t.name}`).join("\n")
