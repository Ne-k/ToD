...
module.exports = {
    config: {
        name: "glomp",
        description: "Glomp (A glomp is a lunging, enthusiastic, over-the-top, and potentially dangerous hug that often begins with a running start, like a tackle.) a user.",
 ...
 let quotes = args.slice(1).join(" ");
        ...
        waifu.setImage(url)
        .setAuthor(`${message.author.username} gave ${user.user.tag} a enthusiastic, over-the-top, and potentially dangerous hug.`, message.author.avatarURL({dynamic: true}))
