...
module.exports = {
    ...
    try {
      ...
      let evalEmbeds = stringTools.toChunks(evaled, 1000).map(thing => new Discord.MessageEmbed()
      .setColor(CC[result])
          ...
          switch (reaction.emoji.name) {
            ...
            case "⏹️":
              ...
              if(message.guild.me.permissions.has('MANAGE_MESSAGES')) {
                ...
                for(let r of queueEmbed.reactions.cache.filter(r => r.users.cache.has(client.user.id)).array()) {
