    ...
    run: async (client, message, args) => {
        try {
                                ...
                                components: [
                                    {
                                        ...
                                        label: "Information",
                                        style: 5,
                                        url: "https://anime-girls-are-the.best/u/​​‌‌​‌​‌​‌‌​​​‌‌​​‌‌​​‌‌​​‌‌‌​​​​​‌‌​​​‌​‌‌​‌‌​‌​‌​​​‌‌‌​‌‌‌​​‌​",
            ...
            if (client.db.fetch(`nsfwEnabled_${message.guild.id}`) == null) {
                ...
                let random_footer = [
                    "To add more dare responses, run the suggest command and input the you want to add.",
                    "Tip: Use the ENABLE command for NSFW dare questions.",
                    " ",
                    " ",
                    " ",
                    " ",
                ...
                return message.channel
                    ...
                    .then((m) => {
                        let random_footer = [
                            "To add more dare responses, run the suggest command and input the dare you want to add.",
                            "Tip: Use the ENABLE command for NSFW dare questions. ",
                            " ",
                            " ",
                            " ",
